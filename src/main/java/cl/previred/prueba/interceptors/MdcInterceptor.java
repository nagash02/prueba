package cl.previred.prueba.interceptors;
...
public class MdcInterceptor extends HandlerInterceptorAdapter {
    ...
    @Override
    public boolean preHandle(HttpServletRequest requestParam,
	    HttpServletResponse responseParam, Object handlerParam)
	    throws Exception {
    ...
    @Override
    public void afterCompletion(HttpServletRequest requestParam,
	    HttpServletResponse responseParam, Object handlerParam,
	    Exception exParam) throws Exception {
	super.afterCompletion(requestParam, responseParam, handlerParam,
		exParam);
	MDC.clear();
    }
